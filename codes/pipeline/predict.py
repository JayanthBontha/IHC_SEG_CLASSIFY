...
def pred_n_plot_test(model, config, test_path='../data/stage2_test_final/', save_plots=False):
    ...
    for mm, image_id in tqdm(enumerate(dataset_test.image_ids)):
        try:
            ...
            print("Error processing image {}".format(image_id))
...
if __name__ == '__main__':
    ...
    folder_path = r"C:\Users\91901\Desktop\Code\data_science_bowl_2018\data\stage1_test"
    ...
    pred_n_plot_test(model, config, test_path=folder_path, save_plots=True)
